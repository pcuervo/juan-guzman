<?php get_header(); ?>
	...
	<section>
		<div class="[ clearfix ][ bg-dark ][ text-center ][ padding-top-bottom--large ]">
	...
	<section>
		<div class="[ relative ]">
			...
			<a class="[ btn btn-primary btn-sm ][ absolute absolute-bottom--0 absolute-left--0 ]" href="#">
				Mapa
			</a>
		</div>
		<div class="[ bg-dark ][ padding ][ text-center color-light ]">
			<h2 class="[]">
